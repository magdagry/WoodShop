	...
	public function widget( $args, $instance ){
		...
		<ul>
			<?php if ( $instance['address'] ): ?>
				<li><span class="flaticon-placeholder"></span><div class="rtin-content"><?php echo wp_kses_post( $instance['address'] );?></div></li>
			<?php endif; ?>

			<?php if ( $instance['phone'] ): ?>
				<li><span class="flaticon-phone-call"></span><a class="rtin-content" href="tel:<?php echo esc_attr( str_replace( array( ' ', '-' ) , '', $instance['phone'] ) );?>"><?php echo esc_html( $instance['phone'] );?></a></li>
			<?php endif; ?>
