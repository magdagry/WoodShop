	...
	public static function get_settings_sections() {
		$fields = [
			'general'         => [
				...
				'fields' => apply_filters( 'rtwpvs_general_setting_fields', [
					[
						'id'      => 'tooltip',
						'type'    => 'checkbox',
			...
			'advanced'        => [
				...
				'fields' => apply_filters( 'rtwpvs_advanced_setting_fields', [
					[
			...
			'style'           => [
				...
				'fields' => apply_filters( 'rtwpvs_style_setting_fields', [
					[
			...
			'archive'         => [
				...
				'fields' => apply_filters( 'rtwpvs_archive_setting_fields', [
					[
						'id'      => 'archive_swatches',
						'is_pro'  => true,
						'type'    => 'checkbox',
			...
			'tools'           => [
				...
				'fields' => apply_filters( 'rtwpvs_tools_setting_fields', [
					[
						'id'    => 'remove_all_data',
						'type'  => 'checkbox',
			...
			'premium_plugins' => [
				...
				'fields' => apply_filters( 'rtwpvs_premium_plugins_setting_fields', [
					[
						'id'         => 'premium_feature',
						'type'       => 'feature',
						'attributes' => [
