		...
		<div class="product-social">
			...
			<ul class="product-social-items">
				<?php foreach ( WC_Functions::social_sharing() as $key => $sharer ): ?>
					<li class="social-<?php echo esc_attr( $key );?>"><a href="<?php echo esc_url( $sharer['url'] );?>" target="_blank" title="<?php echo esc_attr( $sharer['icon'] );?>"><span class="fa <?php echo esc_attr( $sharer['icon'] );?>"></span></a></li>
				<?php endforeach; ?>
			</ul>
		</div>
	<?php endif; ?>
